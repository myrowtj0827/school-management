...
class Quiz(models.Model):
    ...
    course = models.ForeignKey(
        OpenCourse, null=True, blank=True,
...
class Progress(models.Model):
    ...
    """
    student = models.OneToOneField(Student, verbose_name=_("Student"), on_delete=models.CASCADE)
    ...
    def list_all_cou_scores(self, enrolled_student):
        ...
        for cou in OpenCourse.objects.filter(students__in=[enrolled_student]):
    ...
    def update_score(self, question, score_to_add=0, possible_to_add=0):
        ...
        """
        course_test = OpenCourse.objects.filter(title=question.course) \
            .exists()
...
class Sitting(models.Model):
    ...
    user = models.ForeignKey(Student, verbose_name=_("Student"), on_delete=models.CASCADE)
